...
// Uniswap V2 Style
export const POOLS_UNISWAP_V2 = 100;//1000;
export const POOLS_SUSHISWAP = 50;//500;
export const POOLS_SHIBASWAP = 50;//200;

export const DEX_NAME_UNISWAP_V2 = 'uniswapv2';
